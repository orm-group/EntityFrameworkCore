    ...
    public static class RelationalEntityTypeBuilderExtensions
    {
            ...
            [NotNull] this IConventionEntityTypeBuilder entityTypeBuilder, bool fromDataAnnotation = false)
        {
            ...
            if (discriminatorProperty != null)
            {
                ...
                discriminatorProperty.DeclaringEntityType.Builder.RemoveUnusedShadowProperties(new[] { discriminatorProperty });
            }
            ...
            [NotNull] PropertyBuilder discriminatorPropertyBuilder)
        {
            ...
            {
                oldDiscriminatorProperty.DeclaringEntityType.Builder.RemoveUnusedShadowProperties(new[] { oldDiscriminatorProperty });
            }
        ...
        public static bool CanSetDiscriminator(
            ...
            [NotNull] string name,
            bool fromDataAnnotation = false)
            => CanSetDiscriminator(entityTypeBuilder, entityTypeBuilder.Metadata.GetDiscriminatorProperty(), name, type, fromDataAnnotation);
