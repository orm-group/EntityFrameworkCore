...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class SqlServerEntityTypeExtensions
    {
        ...
        public static void SetSqlServerIsMemoryOptimized([NotNull] this IMutableEntityType entityType, bool value)
            => entityType.SetOrRemoveAnnotation(SqlServerAnnotationNames.MemoryOptimized, value);
        ...
        public static void SetSqlServerIsMemoryOptimized(
            [NotNull] this IConventionEntityType entityType, bool value, bool fromDataAnnotation = false)
            => entityType.SetOrRemoveAnnotation(SqlServerAnnotationNames.MemoryOptimized, value, fromDataAnnotation);
