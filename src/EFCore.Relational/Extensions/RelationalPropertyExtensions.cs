...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class RelationalPropertyExtensions
    {
        ...
        public static void SetColumnName([NotNull] this IConventionProperty property, [CanBeNull] string name, bool fromDataAnnotation = false)
            => property.SetOrRemoveAnnotation(
                RelationalAnnotationNames.ColumnName,
                Check.NullButNotEmpty(name, nameof(name)),
                fromDataAnnotation);
        ...
        /// <param name="value"> The value to set. </param>
        /// <param name="fromDataAnnotation"> Indicates whether the configuration was specified using a data annotation. </param>
        public static void SetColumnType([NotNull] this IConventionProperty property, [CanBeNull] string value, bool fromDataAnnotation = false)
            => property.SetOrRemoveAnnotation(
                RelationalAnnotationNames.ColumnType,
                Check.NullButNotEmpty(value, nameof(value)),
                fromDataAnnotation);
        ...
        public static string GetDefaultValueSql([NotNull] this IProperty property)
            => GetDefaultValueSql(property, true);

        private static string GetDefaultValueSql([NotNull] IProperty property, bool fallback)
        {
            if (fallback)
            {
                var sharedTablePrincipalPrimaryKeyProperty = property.FindSharedTableRootPrimaryKeyProperty();
                if (sharedTablePrincipalPrimaryKeyProperty != null)
                {
                    return GetDefaultValueSql(sharedTablePrincipalPrimaryKeyProperty, fallback: false);
                }
            }

            return (string)property[RelationalAnnotationNames.DefaultValueSql];
        }
        ...
        {
            CheckDefaultValueSql(property, value);
        ...
        private static void CheckDefaultValueSql([NotNull] IProperty property, [CanBeNull] string value)
        {
            if (value == null)
            {
                return;
            ...
            if (GetDefaultValue(property, false) != null)
            {
                throw new InvalidOperationException(
                    RelationalStrings.ConflictingColumnServerGeneration(
                        "DefaultValueSql", property.Name,
                        "DefaultValue"));
            }

            if (GetComputedColumnSql(property, false) != null)
            {
                throw new InvalidOperationException(
        ...
        public static string GetComputedColumnSql([NotNull] this IProperty property)
            => GetComputedColumnSql(property, fallback: true);

        private static string GetComputedColumnSql([NotNull] IProperty property, bool fallback)
        {
            if (fallback)
            {
                var sharedTablePrincipalPrimaryKeyProperty = property.FindSharedTableRootPrimaryKeyProperty();
                if (sharedTablePrincipalPrimaryKeyProperty != null)
                {
                    return GetComputedColumnSql(sharedTablePrincipalPrimaryKeyProperty, fallback: false);
                }
            }

            return (string)property[RelationalAnnotationNames.ComputedColumnSql];
        }
        ...
        {
            CheckComputedColumnSql(property, value);
        ...
        private static void CheckComputedColumnSql([NotNull] this IProperty property, [CanBeNull] string value)
        {
            if (value == null)
            {
                return;
            ...
            if (GetDefaultValue(property, fallback: false) != null)
            {
                throw new InvalidOperationException(
                    RelationalStrings.ConflictingColumnServerGeneration("ComputedColumnSql", property.Name, "DefaultValue"));
            }

            if (GetDefaultValueSql(property, fallback: false) != null)
            {
                throw new InvalidOperationException(
                    RelationalStrings.ConflictingColumnServerGeneration("ComputedColumnSql", property.Name, "DefaultValueSql"));
            }
        }
        ...
        public static object GetDefaultValue([NotNull] this IProperty property)
            => GetDefaultValue(property, fallback: true);

        private static object GetDefaultValue([NotNull] IProperty property, bool fallback)
        {
            if (fallback)
            {
                var sharedTablePrincipalPrimaryKeyProperty = property.FindSharedTableRootPrimaryKeyProperty();
                if (sharedTablePrincipalPrimaryKeyProperty != null)
                {
                    return GetDefaultValue(sharedTablePrincipalPrimaryKeyProperty, fallback: false);
                }
            }

            return property[RelationalAnnotationNames.DefaultValue];
        }
        ...
        {
            value = CheckDefaultValue(property, value);

            property.SetOrRemoveAnnotation(RelationalAnnotationNames.DefaultValue, value);
        }
            ...
            [NotNull] this IConventionProperty property, [CanBeNull] object value, bool fromDataAnnotation = false)
        {
            ...
            property.SetOrRemoveAnnotation(RelationalAnnotationNames.DefaultValue, value, fromDataAnnotation);
        }

        private static object CheckDefaultValue([NotNull] IProperty property, [CanBeNull] object value)
        {
            if (value == null)
            {
                return null;
            ...
            if (GetDefaultValueSql(property, fallback: false) != null)
            {
                throw new InvalidOperationException(
                    RelationalStrings.ConflictingColumnServerGeneration(
                        "DefaultValue", property.Name, "DefaultValueSql"));
            }

            if (GetComputedColumnSql(property, fallback: false) != null)
            {
                throw new InvalidOperationException(
                    RelationalStrings.ConflictingColumnServerGeneration(
                        "DefaultValue", property.Name, "ComputedColumnSql"));
            }
        ...
        public static bool IsFixedLength([NotNull] this IProperty property)
            => IsFixedLength(property, fallback: true);

        private static bool IsFixedLength([NotNull] IProperty property, bool fallback)
        {
            if (fallback)
            {
                var sharedTablePrincipalPrimaryKeyProperty = property.FindSharedTableRootPrimaryKeyProperty();
                if (sharedTablePrincipalPrimaryKeyProperty != null)
                {
                    return IsFixedLength(sharedTablePrincipalPrimaryKeyProperty, fallback: false);
                }
            }

            return (bool?)property[RelationalAnnotationNames.IsFixedLength] ?? false;
        }
