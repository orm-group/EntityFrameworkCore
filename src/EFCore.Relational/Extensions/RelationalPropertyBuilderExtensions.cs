...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class RelationalPropertyBuilderExtensions
    {
        ...
        /// <summary>
        ///     Returns a value indicating whether the property can be configured as being fixes length or not.
        /// </summary>
        /// <param name="propertyBuilder"> The builder for the property being configured. </param>
        /// <param name="fixedLength"> A value indicating whether the property is constrained to fixed length values. </param>
        /// <param name="fromDataAnnotation"> Indicates whether the configuration was specified using a data annotation. </param>
        /// <returns> <c>true</c> if the property can be configured as being fixes length or not. </returns>
            ...
            [CanBeNull] string sql)
        {
            ...
            if (propertyBuilder.Metadata.GetDefaultValueSql() != sql)
            {
                propertyBuilder.Metadata.SetDefaultValue(null);
                propertyBuilder.Metadata.SetComputedColumnSql(null);
            }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            if (propertyBuilder.Metadata.GetDefaultValueSql() != sql
                && sql != null)
            {
                ClearAllServerGeneratedValues(propertyBuilder, fromDataAnnotation);
            }
        ...
        public static bool CanSetDefaultValueSql(
            ...
            => propertyBuilder.CanSetAnnotation(
                   ...
                   fromDataAnnotation)
               && (sql == null
                   || (propertyBuilder.CanSetDefaultValue(null, fromDataAnnotation)
                       && propertyBuilder.CanSetComputedColumnSql(null, fromDataAnnotation)));
            ...
            [CanBeNull] string sql)
        {
            ...
            if (propertyBuilder.Metadata.GetComputedColumnSql() != sql)
            {
                propertyBuilder.Metadata.SetDefaultValue(null);
                propertyBuilder.Metadata.SetDefaultValueSql(null);
            }
        ...
        public static bool CanSetComputedColumnSql(
            ...
            => propertyBuilder.CanSetAnnotation(
               ...
               && (sql == null
                   || (propertyBuilder.CanSetDefaultValue(null, fromDataAnnotation)
                       && propertyBuilder.CanSetDefaultValueSql(null, fromDataAnnotation)));
            ...
            [CanBeNull] object value = null)
        {
            ...
            if (propertyBuilder.Metadata.GetDefaultValue() != value)
            {
                propertyBuilder.Metadata.SetDefaultValueSql(null);
                propertyBuilder.Metadata.SetComputedColumnSql(null);
            }
        ...
        private static void ClearAllServerGeneratedValues(
            [NotNull] IConventionPropertyBuilder propertyBuilder,
            bool fromDataAnnotation)
        {
            var property = propertyBuilder.Metadata;
            property.SetDefaultValue(null, fromDataAnnotation);
            property.SetDefaultValueSql(null, fromDataAnnotation);
            property.SetComputedColumnSql(null, fromDataAnnotation);
        }
    }
}
