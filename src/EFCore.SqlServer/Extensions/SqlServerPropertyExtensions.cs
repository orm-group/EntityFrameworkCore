...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class SqlServerPropertyExtensions
    {
        ...
        public static SqlServerValueGenerationStrategy? GetSqlServerValueGenerationStrategy([NotNull] this IProperty property)
            => GetSqlServerValueGenerationStrategy(property, fallback: true);

        private static SqlServerValueGenerationStrategy? GetSqlServerValueGenerationStrategy([NotNull] IProperty property, bool fallback)
        {
            ...
            if (property.ValueGenerated != ValueGenerated.OnAdd)
            {
                ...
                return sharedTablePrincipalPrimaryKeyProperty?.GetSqlServerValueGenerationStrategy() == SqlServerValueGenerationStrategy.IdentityColumn
